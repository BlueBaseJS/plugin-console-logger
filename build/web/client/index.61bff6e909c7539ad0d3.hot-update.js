...
var LoggerPlugin = Object(_bluebase_core__WEBPACK_IMPORTED_MODULE_0__["createPlugin"])({
  ...
  filters: {
    ...
    'bluebase.logger.log': function bluebaseLoggerLog(message, _ref, BB) {
      ...
      console.group("%cBlueBase", "background-image: '../assets/common/BlueBase-logo.png' ; background-size: 12px; background-repeat : no-repeat ; background-position:left ; padding-left:18px");
      console.log(message);
...
//# sourceMappingURL=index.61bff6e909c7539ad0d3.hot-update.js.map