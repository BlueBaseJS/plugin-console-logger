...
var LoggerPlugin = Object(_bluebase_core__WEBPACK_IMPORTED_MODULE_0__["createPlugin"])({
  ...
  filters: {
    ...
    'bluebase.logger.log': function bluebaseLoggerLog(message, _ref, BB) {
      ...
      console.group("%cBlueBase", "background-image: url(__dirname + '/assets/common/logo.png') ; background-size: 12px; background-repeat : no-repeat ; background-position:left ; padding-left:18px");
      console.log(message);
...
//# sourceMappingURL=index.6e913aafa0f42c683855.hot-update.js.map