...
export default createPlugin({
	...
	filters: {
		'bluebase.logger.debug': (message: string, { params }: any, BB: BlueBase) => {
			console.group(
				'%cBlueBase',
				'background-image: url("https://blobscdn.gitbook.com/v0/b/gitbook-28427.appspot.com/o/spaces%2F-LPjsIbS1DfhqT8BS3Ui%2Favatar.png?generation=1540566320738340&alt=media") ; background-size: 12px; background-repeat : no-repeat ; background-position:left ; padding-left:18px'
			);
